      ...
      fetch(this.dataset.url)
        ...
        .then(text => {
          ...
          if (html.querySelector('.grid__item')) {
            ...
            this.classList.add('recom-has-products')
          }
          else{
            document.querySelector('.related-prod-parent').classList.add('recom-no-products-parent')
            this.classList.add('recom-no-products')
          }
        })
        .catch(e => {
          console.error(e);
